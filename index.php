	...
	<div class="sidebar">
		...
		<div class="menu">
			...
			<ul>
				...
				<li <?php echo $gp; ?>><a href="index.php?p=ganti_password"><i class="fas fa-user-lock"></i> Ganti
						Password</a></li>
				...
				<li <?php echo $lpr; ?> id="lpr1" style="background-color: #2c3b41;"><a
						href="index.php?p=laporan_pertanggal" style="margin-left: 10px;">Per Tanggal</a></li>

				<li <?php echo $lpr; ?> id="lpr2" style="background-color: #2c3b41;"><a
						href="index.php?p=laporan_perbulan" style="margin-left: 10px;">Per Bulan</a></li>

				<li <?php echo $lpr; ?> id="lpr3" style="background-color: #2c3b41;"><a
						href="index.php?p=laporan_pertahun" style="margin-left: 10px;">Per Tahun</a></li>
